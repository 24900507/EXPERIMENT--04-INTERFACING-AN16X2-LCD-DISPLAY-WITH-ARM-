# EXPERIMENT - 04 - INTERFACING A 16X2 LCD DISPLAY WITH ARM AND DISPLAY STRING
...
{
    Lcd_cursor(&lcd, 0, 1);
    Lcd_string(&lcd, "AKASH G\n");

    Lcd_cursor(&lcd, 1, 1);
    Lcd_string(&lcd, "212224100004\n");
}
...
![Screenshot(1)](https://github.com/user-attachments/assets/081cd468-77d1-4895-973e-6fda28b649b7)

## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 
<img width="1015" height="716" alt="Screenshot 2025-09-19 at 2 19 54 PM" src="https://github.com/user-attachments/assets/985adc5b-301e-4871-9fb2-7152bb1da1d9" />
